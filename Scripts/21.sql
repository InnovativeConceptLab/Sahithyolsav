USE [DB_Sahithyolsav]
GO
/****** Object:  StoredProcedure [dbo].[SpGetParticipantByLevelId2]    Script Date: 08/27/2014 23:02:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER proc [dbo].[SpGetParticipantByLevelId2]
	@LevelId as int,
...
AND intParticipantToLevelId = @intParticipantLevelId and intadedUserId=@addedUserId