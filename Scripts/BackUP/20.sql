USE [DB_Sahithyolsav]
GO
/****** Object:  StoredProcedure [dbo].[SpGetParticipantByLevelId1]    Script Date: 08/27/2014 23:01:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER proc [dbo].[SpGetParticipantByLevelId1]
	@LevelId as int,
...
AND intParticipantToLevelId = @intParticipantLevelId