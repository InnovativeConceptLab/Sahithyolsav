<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmTabulation.aspx.vb"
    Inherits="Sahithyolsav.frmTabulation" %>
    ...
    <asp:UpdatePanel ID="levelUpdatePnel" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlContent" runat="server" Visible="false">
                ...
                <div style="width: 100%; height: 380px; overflow: auto" class="rounded_corners">
                    <asp:GridView runat="server" ID="gvCodeLtterMapdetails" DataKeyNames="intTabulationId" Width="100%"
                        AutoGenerateColumns="false"  HeaderStyle-Height="30px" EmptyDataText="No Data Seleted">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit Marks" Visible="true" HeaderStyle-Width="170px" >
                                <ItemTemplate>
                                    <asp:TextBox ID="txtMarks1" runat="server" Width="30px" TabIndex="1" onkeypress="return isNumberKey(event);" />
                                    <asp:TextBox ID="txtMarks2" runat="server" Width="30px" TabIndex="2" onkeypress="return isNumberKey(event);" />
                                    <asp:TextBox ID="txtMarks3" runat="server" Width="30px" TabIndex="3" onkeypress="return isNumberKey(event);" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="DistrictID" Visible="false">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblCodeLetterMapID" runat="server" Text='<%# Bind("CodeLetterMapID") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Font-Size="10px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-Width="60px" HeaderText="">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSaveMark" runat="server" OnClick="btnSaveMark_Click" ImageUrl="~/image/submit.jpg" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <table width="100%" style="border: Solid 3px #4b6c9e; width: 420px; height: 100%"
                    ...
                    <tr style="background-color: #4b6c9e">
                        <td colspan="2" style="height: 10%; color: White; font-weight: bold; font-size: larger"
                            ...
                            <asp:HiddenField ID="htabulationid" runat="server" />
                            Participant Details
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 70%">
                            <asp:TextBox ID="txtCodeLetter" runat="server" Width="90%" Enabled="false" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 30%" align="right">
                        ...
                        <td style="width: 70%">
                            <asp:TextBox ID="txtMarks" runat="server" Width="90%" />
                        </td>
                    </tr>
                    <tr>
