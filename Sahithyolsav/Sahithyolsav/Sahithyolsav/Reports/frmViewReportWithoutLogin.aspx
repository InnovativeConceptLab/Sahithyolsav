<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmViewReportWithoutLogin.aspx.vb" Inherits="Sahithyolsav.frmViewReportWithoutLogin" %>
    ...
    <div>
        ...
        <div id="divgridRport" runat="server">
            ...
            <div style="width: 100%;height: 300px; overflow: auto" class="rounded_corners">
                <asp:GridView runat="server" ID="gvReport" AutoGenerateColumns="true" Width="100%"
                    HeaderStyle-Height="30px" EmptyDataText="No Data Seleted" OnRowCreated="gvReport_RowCreated">
