...
Public Class frmViewReportWithoutLogin
    ...
    Protected Sub ddlReports_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlReports.SelectedIndexChanged
        ...
        If dt.Rows.Count > 0 Then
            ...
            Else
                ...
                arrIn.Add(0)
                arrIn.Add(0)
                arrIn.Add(1) 'Default state user UserManagement.UserMapId
                arrIn.Add(1) 'Default state user
                arrIn.Add(0)
    ...
    Protected Sub imgSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgSearch.Click
        ...
        End If
        arrIn.Add(1) 'Selected state user as default UserManagement.UserMapId
        arrIn.Add(1) 'Selected state user as default UserManagement.UserTypeId
        arrIn.Add(0)
