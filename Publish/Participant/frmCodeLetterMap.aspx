<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCodeLetterMap.aspx.vb"
    Inherits="Sahithyolsav.frmCodeLetterMap" %>
            ...
            <div runat="server" id="sublist" class="searchTableStyle" style="display: none; width: 99.5%">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <%-- <td runat="server" id="level6" align="center" style="width:20%">
                            <asp:ImageButton ID="imgLevel" runat="server" ImageUrl="~/image/submit.jpg" Height="20px"
                                Width="70px" Style="margin-left: 0px" />
                        </td>--%>
                    </tr>
                </table>
            </div>
                ...
                <div style="width: 100%; height: 350px; overflow: auto" class="rounded_corners">
                    <asp:GridView runat="server" ID="gvCodeLtterMapdetails" DataKeyNames="CodeLetterMapID"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Code Letter" Visible="true">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtCodeLetter" runat="server" Width="80px" Text='<%# Bind("CodeLetter") %>' />
                                </ItemTemplate>
                                <ItemStyle Font-Size="10px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-Width="60px" HeaderText="">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSaveCode" runat="server" OnClick="btnCodeletterSave_Click"
